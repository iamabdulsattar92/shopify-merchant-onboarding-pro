...
export default function Index() {
  const { profile, onboardingSuccess } = useLoaderData<typeof loader>();
  ...
  return (
    <Page>
      ...
      <BlockStack gap="500">
        {onboardingSuccess && (
          <Banner tone="success" title="Profile Saved Successfully">
            <p>Your information has been written to the PostgreSQL database.</p>
          </Banner>
        )}
        <Layout>
          {!profile && (
              ...
              <BlockStack gap="500">
                <BlockStack gap="200">
                  <Text as="h2" variant="headingMd">
                    {profile ? `Welcome back, ${profile.firstName}! 👋` : "Congrats on creating a new Shopify app 🎉"}
                  </Text>
